import{bw as A,e as E,j as t,D as m}from"./index-BciFvkTs.js";import{u as M}from"./useGraderAnswer-B6017d5P.js";function Q(r){const{fields:x,kids:i}=r;A(i,["type","parsed","message","technical"]);const[c,j]=E(r,x.value,{}),{showAnswer:f,displayAnswer:b}=M(r);if(r.parseError)return t.jsx(m,{props:r,title:"TabularMCQ Parse Error",message:String(i.message||"Failed to parse TabularMCQ content"),technical:i.technical?JSON.stringify(i.technical,null,2):void 0});if(!i||!i.parsed)return t.jsx(m,{props:r,title:"TabularMCQ Error",message:"No content provided",technical:`Expected YAML content inside <TabularMCQ>:
cols: Col1, Col2, Col3
rows: Row1, Row2, Row3
